...
DO $$
BEGIN
    -- Create workspace_plan type if it doesn't exist (uncommented it since it's used)
    IF NOT EXISTS (SELECT 1 FROM pg_type t JOIN pg_namespace n ON n.oid = t.typnamespace WHERE t.typname = 'workspace_plan' AND n.nspname = 'public') THEN
    ...
    IF NOT EXISTS (SELECT 1 FROM pg_type t JOIN pg_namespace n ON n.oid = t.typnamespace WHERE t.typname = 'testimonial_type' AND n.nspname = 'public') THEN
        CREATE TYPE testimonial_type AS ENUM ('customer', 'employee', 'partner', 'influencer', 'expert', 'case_study');
    END IF;
    
    IF NOT EXISTS (SELECT 1 FROM pg_type t JOIN pg_namespace n ON n.oid = t.typnamespace WHERE t.typname = 'content_format' AND n.nspname = 'public') THEN
    ...
    IF NOT EXISTS (SELECT 1 FROM pg_type t JOIN pg_namespace n ON n.oid = t.typnamespace WHERE t.typname = 'collection_method' AND n.nspname = 'public') THEN
    ...
    IF NOT EXISTS (SELECT 1 FROM pg_type t JOIN pg_namespace n ON n.oid = t.typnamespace WHERE t.typname = 'verification_type' AND n.nspname = 'public') THEN
    ...
    IF NOT EXISTS (SELECT 1 FROM pg_type t JOIN pg_namespace n ON n.oid = t.typnamespace WHERE t.typname = 'ai_service_category' AND n.nspname = 'public') THEN
    ...
    IF NOT EXISTS (SELECT 1 FROM pg_type t JOIN pg_namespace n ON n.oid = t.typnamespace WHERE t.typname = 'sentiment' AND n.nspname = 'public') THEN
        CREATE TYPE sentiment AS ENUM (
            'very_negative', 'negative', 'neutral', 'positive', 'very_positive'
        );
    END IF;
    
    IF NOT EXISTS (SELECT 1 FROM pg_type t JOIN pg_namespace n ON n.oid = t.typnamespace WHERE t.typname = 'integration_type' AND n.nspname = 'public') THEN
    ...
    IF NOT EXISTS (SELECT 1 FROM pg_type t JOIN pg_namespace n ON n.oid = t.typnamespace WHERE t.typname = 'placement_type' AND n.nspname = 'public') THEN
    ...
    IF NOT EXISTS (SELECT 1 FROM pg_type t JOIN pg_namespace n ON n.oid = t.typnamespace WHERE t.typname = 'analysis_type' AND n.nspname = 'public') THEN
    ...
    IF NOT EXISTS (SELECT 1 FROM pg_type t JOIN pg_namespace n ON n.oid = t.typnamespace WHERE t.typname = 'testimonial_style' AND n.nspname = 'public') THEN
        CREATE TYPE testimonial_style AS ENUM (
            'minimal', 'card', 'quote', 'bubble', 'highlight', 'modern', 'classic'
        );
    END IF;
    
    IF NOT EXISTS (SELECT 1 FROM pg_type t JOIN pg_namespace n ON n.oid = t.typnamespace WHERE t.typname = 'testimonial_layout' AND n.nspname = 'public') THEN
        CREATE TYPE testimonial_layout AS ENUM (
            'grid', 'carousel', 'masonry', 'list'
        );
    END IF;
    
    IF NOT EXISTS (SELECT 1 FROM pg_type t JOIN pg_namespace n ON n.oid = t.typnamespace WHERE t.typname = 'business_event_type' AND n.nspname = 'public') THEN
    ...
    IF NOT EXISTS (SELECT 1 FROM pg_type t JOIN pg_namespace n ON n.oid = t.typnamespace WHERE t.typname = 'trigger_type' AND n.nspname = 'public') THEN
...
-- Modified to handle the case where workspace_plan might not exist yet
CREATE OR REPLACE FUNCTION cascade_workspace_deletion()
RETURNS TRIGGER AS $$
BEGIN
    -- Log the deletion event with a safer approach to the plan field
    INSERT INTO audit_log (
        ...
        jsonb_build_object(
            ...
            'workspace_plan', COALESCE(OLD.plan::text, 'unknown'),
...
BEGIN
    ...
    IF NOT EXISTS (SELECT 1 FROM pg_tables WHERE schemaname = 'public' AND tablename = 'brand_guides') THEN
        ...
        CREATE INDEX IF NOT EXISTS idx_brand_guides_workspace ON brand_guides(workspace_id);
    END IF;
...
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_tables WHERE schemaname = 'public' AND tablename = 'customer_profiles') THEN
        ...
        CREATE UNIQUE INDEX IF NOT EXISTS idx_customer_profiles_workspace_email ON customer_profiles (workspace_id, email) WHERE email IS NOT NULL;
        CREATE INDEX IF NOT EXISTS idx_customer_profiles_external_id ON customer_profiles(external_id);
    END IF;
    
    IF NOT EXISTS (SELECT 1 FROM pg_tables WHERE schemaname = 'public' AND tablename = 'testimonials') THEN
        ...
        CREATE INDEX IF NOT EXISTS idx_testimonials_workspace ON testimonials(workspace_id);
        CREATE INDEX IF NOT EXISTS idx_testimonials_status ON testimonials(status);
        CREATE INDEX IF NOT EXISTS idx_testimonials_testimonial_type ON testimonials(testimonial_type);
        ...
        CREATE INDEX IF NOT EXISTS idx_testimonials_content_trgm ON testimonials USING gin(content gin_trgm_ops);
        CREATE INDEX IF NOT EXISTS idx_testimonials_collection_method ON testimonials(collection_method);
        CREATE UNIQUE INDEX IF NOT EXISTS idx_testimonials_source_data ON testimonials((source_data->>'review_id')) WHERE source_data->>'review_id' IS NOT NULL;
    END IF;
END$$;
...
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_tables WHERE schemaname = 'public' AND tablename = 'testimonial_analyses') THEN
        ...
        CREATE INDEX IF NOT EXISTS idx_testimonial_analyses_testimonial ON testimonial_analyses(testimonial_id);
        CREATE INDEX IF NOT EXISTS idx_testimonial_analyses_type ON testimonial_analyses(analysis_type);
    END IF;
    
    IF NOT EXISTS (SELECT 1 FROM pg_tables WHERE schemaname = 'public' AND tablename = 'competitor_mentions') THEN
        ...
        CREATE INDEX IF NOT EXISTS idx_competitor_mentions_testimonial ON competitor_mentions(testimonial_id);
        CREATE INDEX IF NOT EXISTS idx_competitor_mentions_name ON competitor_mentions(competitor_name);
    END IF;
    
    IF NOT EXISTS (SELECT 1 FROM pg_tables WHERE schemaname = 'public' AND tablename = 'ai_jobs') THEN
        ...
        CREATE INDEX IF NOT EXISTS idx_ai_jobs_testimonial ON ai_jobs(testimonial_id);
...
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_tables WHERE schemaname = 'public' AND tablename = 'collection_triggers') THEN
        ...
        CREATE INDEX IF NOT EXISTS idx_collection_triggers_workspace ON collection_triggers(workspace_id);
        CREATE INDEX IF NOT EXISTS idx_collection_triggers_type ON collection_triggers(type);
        CREATE INDEX IF NOT EXISTS idx_collection_triggers_method ON collection_triggers(collection_method);
    END IF;
    
    IF NOT EXISTS (SELECT 1 FROM pg_tables WHERE schemaname = 'public' AND tablename = 'collection_portals') THEN
        ...
        CREATE INDEX IF NOT EXISTS idx_collection_portals_workspace ON collection_portals(workspace_id);
    END IF;
END$$;
...
BEGIN
    ...
    IF NOT EXISTS (SELECT 1 FROM pg_tables WHERE schemaname = 'public' AND tablename = 'social_campaigns') THEN
        ...
        CREATE INDEX IF NOT EXISTS idx_social_campaigns_workspace ON social_campaigns(workspace_id);
        CREATE INDEX IF NOT EXISTS idx_social_campaigns_status ON social_campaigns(status);
    END IF;
    
    IF NOT EXISTS (SELECT 1 FROM pg_tables WHERE schemaname = 'public' AND tablename = 'social_platform_connections') THEN
        ...
        CREATE INDEX IF NOT EXISTS idx_social_platform_connections_workspace ON social_platform_connections(workspace_id);
        CREATE INDEX IF NOT EXISTS idx_social_platform_connections_platform ON social_platform_connections(platform_name);
    END IF;
END$$;
...
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_tables WHERE schemaname = 'public' AND tablename = 'collections') THEN
    ...
    IF NOT EXISTS (SELECT 1 FROM pg_tables WHERE schemaname = 'public' AND tablename = 'collection_items') THEN
        ...
        CREATE INDEX IF NOT EXISTS idx_collection_items_testimonial ON collection_items(testimonial_id);
    END IF;
    
    IF NOT EXISTS (SELECT 1 FROM pg_tables WHERE schemaname = 'public' AND tablename = 'collection_widgets') THEN
        ...
        CREATE INDEX IF NOT EXISTS idx_collection_widgets_workspace ON collection_widgets(workspace_id);
    END IF;
    
    IF NOT EXISTS (SELECT 1 FROM pg_tables WHERE schemaname = 'public' AND tablename = 'display_widgets') THEN
    ...
    IF NOT EXISTS (SELECT 1 FROM pg_tables WHERE schemaname = 'public' AND tablename = 'display_templates') THEN
        ...
        CREATE INDEX IF NOT EXISTS idx_display_templates_workspace ON display_templates(workspace_id);
    END IF;
    
    IF NOT EXISTS (SELECT 1 FROM pg_tables WHERE schemaname = 'public' AND tablename = 'display_placements') THEN
        ...
        CREATE INDEX IF NOT EXISTS idx_display_placements_workspace ON display_placements(workspace_id);
        CREATE INDEX IF NOT EXISTS idx_display_placements_widget ON display_placements(collection_widget_id);
    END IF;
END$$;
...
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_tables WHERE schemaname = 'public' AND tablename = 'assignments') THEN
        ...
        CREATE INDEX IF NOT EXISTS idx_assignments_testimonial ON assignments(testimonial_id);
    ...
    IF NOT EXISTS (SELECT 1 FROM pg_tables WHERE schemaname = 'public' AND tablename = 'comments') THEN
        ...
        CREATE INDEX IF NOT EXISTS idx_comments_testimonial ON comments(testimonial_id);
        CREATE INDEX IF NOT EXISTS idx_comments_team_member ON comments(team_member_id);
    END IF;
END$$;
...
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_tables WHERE schemaname = 'public' AND tablename = 'analytics_events') THEN
        ...
        CREATE INDEX IF NOT EXISTS idx_analytics_events_testimonial ON analytics_events(testimonial_id);
    END IF;
    
    IF NOT EXISTS (SELECT 1 FROM pg_tables WHERE schemaname = 'public' AND tablename = 'conversion_tracking') THEN
        ...
        CREATE INDEX IF NOT EXISTS idx_conversion_tracking_testimonial ON conversion_tracking(testimonial_id);
        CREATE INDEX IF NOT EXISTS idx_conversion_tracking_display ON conversion_tracking(display_id);
    END IF;
END$$;
...
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_tables WHERE schemaname = 'public' AND tablename = 'platform_integrations') THEN
...
BEGIN
    ...
    IF NOT EXISTS (SELECT 1 FROM pg_trigger WHERE tgname = 'update_brand_guides_updated_at') THEN
    ...
    IF NOT EXISTS (SELECT 1 FROM pg_trigger WHERE tgname = 'update_collection_portals_updated_at') THEN
    ...
    IF NOT EXISTS (SELECT 1 FROM pg_trigger WHERE tgname = 'update_display_widgets_updated_at') THEN
