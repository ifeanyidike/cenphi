...
export const SignUpForm: React.FC<AuthFormProps & { onBack?: () => void }> = ({
  ...
  const handleSocialLogin = async (provider: SocialProvider) => {
    await authStore.socialLoginPopup(provider);
  };
                    ...
                    <div className="space-y-5">
                      ...
                      >
                        <div className="relative group">
                          ...
                          {(formErrors.name || error?.field === "name") && (
                      ...
                      >
                        <div className="relative group">
                          ...
                          {(formErrors.email || error?.field === "email") && (
                            <p className="text-red-500 text-xs mt-1">
                    ...
                    >
                      {[
                        ...
                        <motion.button
                          ...
                          whileTap={{ scale: 0.97 }}
                          onClick={() =>
                            handleSocialLogin(provider.name as SocialProvider)
                          }
