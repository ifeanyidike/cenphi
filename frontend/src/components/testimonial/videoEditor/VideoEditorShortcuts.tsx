...
type VideoEditorShortcutsProps = {
  showKeyboardShortcuts: boolean;
  setShowKeyboardShortcuts: Dispatch<SetStateAction<boolean>>;
  isDarkMode: boolean;
};
const VideoEditorShortcuts: FC<VideoEditorShortcutsProps> = ({
        ...
        >
          ...
          >
            ...
            <div className="mt-4">
              ...
              >
                <li>Right-click timeline for context menu options</li>
                <li>Ctrl + Mouse Wheel to zoom timeline</li>
                <li>Drag trim handles to adjust trim points</li>
...
export default VideoEditorShortcuts;
