...
// // Generate company initial avatar
...
//     store.updateBrandData(["email", "signature", "text"], newSignature);
//     store.updateBrandData(["email", "signature", "template"], template);
//     setActiveSignatureTemplate(template);
//   };
//   return (
//     <>
//       <Accordion type="single" collapsible className="w-full mb-4">
//         <AccordionItem value="sender-settings">
...
//                   value={brandData.voice.channels.email?.sender.email || ""}
//                   onChange={(e) =>
...
//                   The email address testimonial requests will be sent from
//                 </p>
//               </div>

//               <div className="space-y-3">
//                 <Label htmlFor="sender-name">Sender Name/Title</Label>
//                 <Input
//                   id="sender-name"
//                   placeholder="Jane Smith or Customer Success Team"
...
//         <AccordionItem value="signature-settings">
//           <AccordionTrigger className="hover:no-underline py-2">
//             <span className="flex items-center text-sm font-medium">
...
//                       <Label htmlFor="include-social" className="text-sm">
...
//                           store.updateBrandData(
//                             ["email", "signature", "includeSocialLinks"],
//                             checked
//                           )
//                         }
//                       />
...
//                       <Button
//                         variant={
//                           activeSignatureTemplate === "simple"
//                             ? "default"
//                             : "outline"
//                         }
//                         className="justify-start text-left h-auto py-2 text-xs"
//                         onClick={() => applySignatureTemplate("simple")}
//                       >
...
//                       <Button
//                         variant={
//                           activeSignatureTemplate === "professional"
//                             ? "default"
//                             : "outline"
//                         }
//                         className="justify-start text-left h-auto py-2 text-xs"
//                         onClick={() => applySignatureTemplate("professional")}
//                       >
//                         <div className="flex flex-col items-start">
...
//                       <Button
//                         variant={
//                           activeSignatureTemplate === "detailed"
//                             ? "default"
//                             : "outline"
//                         }
//                         className="justify-start text-left h-auto py-2 text-xs"
//                         onClick={() => applySignatureTemplate("detailed")}
//                       >
//                         <div className="flex flex-col items-start">
//                           <span>Detailed</span>
//                           <span className="text-xs text-gray-500 dark:text-gray-400">
...
//                       <Button
//                         variant={
//                           activeSignatureTemplate === "marketing"
//                             ? "default"
//                             : "outline"
//                         }
//                         className="justify-start text-left h-auto py-2 text-xs"
//                         onClick={() => applySignatureTemplate("marketing")}
//                       >
//                         <div className="flex flex-col items-start">
//                           <span>Marketing</span>
//                           <span className="text-xs text-gray-500 dark:text-gray-400">
...
//                   <div className="rounded-md bg-gray-50 dark:bg-gray-900 p-2 text-xs mt-2">
...
//                     onClick={() => {
//                       // Copy signature functionality would go here
...
//                       {/* Logo or Avatar */}
//                       {brandData.logo?.main ? (
//                         <div className="mb-3 h-10 max-w-[120px]">
//                           <img
