...
export const PendingCardView: React.FC<RenderCardViewProps> = ({
  ...
  const renderCardTestimonial = (testimonial: Testimonial) => {
    ...
    return (
      ...
      >
        {/* Premium ribbon for pending testimonials - only visible on hover */}
        ...
        <div className="space-y-5">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-center 
            ...
            <div className="flex space-x-2">
              <button 
                onClick={() => handleActionClick(testimonial, 'approve')}
              ...
              <button 
                onClick={() => handleActionClick(testimonial, 'reject')}
