...
export function SentimentMiniCharts({ sentiment, isDarkMode = true }: SentimentMiniChartsProps) {
  // Generate keyword data for charts - handle keywords as string array
  const generateKeywordData = () => {
    ...
    return sentiment.keywords.map((keyword, index) => {
  ...
  // Sentiment score indicator data
  ...
  const distributionData = [
    { name: 'Positive', value: sentiment.score > 0.6 ? 60 : 30 },
    { name: 'Neutral', value: sentiment.score > 0.4 && sentiment.score < 0.6 ? 50 : 20 },
    { name: 'Negative', value: sentiment.score < 0.4 ? 50 : 20 }
  ];
  ...
  const historyData = [
    ...
    { date: 'Tue', score: 0.72 },
    { date: 'Wed', score: 0.58 },
    { date: 'Thu', score: sentiment.score },
    { date: 'Fri', score: sentiment.score + 0.05 > 1 ? 0.98 : sentiment.score + 0.05 }
  ];
