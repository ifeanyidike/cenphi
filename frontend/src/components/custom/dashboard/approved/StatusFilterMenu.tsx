...
const ApprovedFilterMenu: React.FC<StatusFilterMenuProps> = ({
  ...
  return (
    <div className="relative" ref={filterRef}>
      <button
        onClick={() => setFilterMenuOpen(!statusfilterMenuOpen)}
        className={`p-2 rounded-lg transition-colors ${
          statusfilterMenuOpen || activeFilters.length > 0 || searchQuery
      ...
      {statusfilterMenuOpen && (
        <div className="absolute right-0 mt-2 w-72 bg-white rounded-xl shadow-lg z-50 border border-gray-100 overflow-hidden">
          ...
          <div className="max-h-80 overflow-y-auto">
            {statusFilterOptions.map((filterGroup, index) => (
              <div
                key={index}
...
export default ApprovedFilterMenu;
