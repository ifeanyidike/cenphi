          ...
          <div className="p-6">
            <div className="space-y-4">
              {[
                ...
                <div
                  key={index}
                  className="flex items-center gap-3 text-[#4C4C47] group hover:text-[#2D2D2A] transition-colors duration-300"
                >
          ...
          <div className="p-6">
            <div className="space-y-4">
              {[
                ...
                <div
                  key={index}
                  className="flex items-center gap-3 text-[#848FA5] group hover:text-[#E5DCC5] transition-colors duration-300"
                >
            ...
            <div className="mt-6 bg-[#4C4C47] rounded-xl p-4">
              <p className="text-[#E5DCC5] font-medium">
                Average conversion rate: 8.47%
              </p>
            </div>
          </div>
        </div>
