...
const Navbar = () => {
  ...
  return (
    <nav
      className={`fixed max-7xl top-0 left-0 right-0 z-50 transition-all duration-300 overflow-hidden ${
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 md:h-20">
          <div className="flex-shrink-0 flex items-center">
            <Link to="/home" className="ml-2 text-xl font-bold text-gray-800">
              <CenphiLogo />
            </Link>
          </div>
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <div className="flex items-center gap-4">
              <Link
                to="/signin"
                className="text-gray-600 hover:text-gray-900 mx-2 px-4 py-2 rounded-lg"
              >
                Login
              </Link>
              <Link
                to="signup"
                className="px-8 py-3 bg-[#2D2D2A] text-[#FFFFFF] font-semibold rounded-full hover:bg-[#C14953] transition-colors duration-300"
              >
                Join for free
              </Link>
            </div>
