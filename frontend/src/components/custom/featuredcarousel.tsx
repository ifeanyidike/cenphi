  ...
  const features = [
    {
      ...
      description:
        "Keep all your testimonials organized with smart filtering tools.",
    ...
    },
    {
      ...
      description:
        "Convert video reviews to text automatically for easy organization.",
    ...
    },
    {
      ...
      description:
        "Find the perfect testimonial instantly with powerful filters.",
    ...
    },
    {
      ...
      description:
        "Download high-quality videos ready for your marketing needs.",
