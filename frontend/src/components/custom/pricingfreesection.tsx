  ...
  const features = [
    {
      ...
      description: "Collect 15 video and text testimonials more than anywhere else",
      category: "Collection"
    },
    {
    ...
    {
      title: "Smart Invites",
      description: "Invite happy customers individually or in bulk with automated follow-ups",
      category: "Management"
    },
    {
      title: "Social Import",
      ...
      <div className="max-w-6xl mx-auto px-4 py-16 md:py-24">
        <div className="text-center mb-16">
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-[#4C4C47] text-lg">
              Free, forever. Start collecting and sharing authentic testimonials today. 
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {features.map((feature, index) => (
            <Card key={index} className="p-6 bg-white hover:shadow-xl transition-all duration-300 border border-[#848FA5]/20 hover:border-[#C14953]/30">
              <div className="flex items-start gap-4">
                <div className="mt-1">
                  <CheckCircle2 className="w-5 h-5 text-[#C14953]" />
                </div>
                <div>
                  <h3 className="font-semibold text-[#2D2D2A] mb-2">{feature.title}</h3>
                  <p className="text-[#848FA5] text-sm">{feature.description}</p>
                </div>
              </div>
            </Card>
          ))}
        ...
        <div className="mt-12 text-center">
          ...
          <p className="mt-4 text-[#848FA5] text-sm">
