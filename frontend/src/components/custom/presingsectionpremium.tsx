    ...
    <Card className="bg-[#E5DCC5] p-8 rounded-2xl border border-[#4C4C47] hover:border-[#C14953] transition-all duration-300 shadow-md hover:shadow-xl">
      <div className="space-y-6 text-[#2D2D2A]">
        <div className="flex justify-between items-center">
          ...
          {tier.bestValue && (
            <span className="bg-[#C14953] text-white px-3 py-1 rounded-lg text-xs">
              Best Value
            </span>
          )}
        </div>
      ...
      features: [
        {
          name: "Spin the Wheel",
          description:
            "Collect twice as many testimonials with our reward system",
          icon: <RefreshCw />,
        },
        {
          name: "Custom Domains",
      ...
      features: [
        {
          name: "Team access",
          description:
            "Let everyone on your team get to share your social proof with 5 seats included",
          icon: <Users />,
        },
        {
    ...
    <div className="w-full max-w-7xl mx-auto p-4 md:p-8 overflow-hidden">
      <div className="py-20 px-4 bg-gradient-to-b from-[#2D2D2A] to-[#4C4C47] text-[#E5DCC5] rounded-2xl">
        <div className="text-center mb-16">
          ...
          <p className="text-lg">
            Upgrade to unlock powerful features and grow faster.
          </p>
        </div>
          ...
          <div className="bg-[#848FA5] p-2 rounded-full inline-flex items-center">
            <button
              className={`px-6 py-2 rounded-full transition-all ${
                !isYearly ? "bg-white text-[#2D2D2A]" : "text-white"
              }`}
            ...
            <div className="ml-3 bg-[#C14953] text-white text-sm px-3 py-1 rounded-full">
              Save 15%
            </div>
          </div>
        </div>
