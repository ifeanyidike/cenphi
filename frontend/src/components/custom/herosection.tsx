        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8 bg-white/70 backdrop-blur-sm rounded-3xl p-8 shadow-md">
            ...
            <div className="flex flex-wrap gap-4">
              <Button
                size="lg"
                className=" bg-teal-600  hover:bg-teal-200 text-white hover:text-black px-8"
              >
                Start for free
            ...
            <div className="flex items-center gap-4 mt-8">
              <div className="flex -space-x-3">
                {[1, 2, 3, 4].map((_, i) => (
                  <div
                    key={i}
                    className="w-10 h-10 rounded-full border-2 border-white bg-gradient-to-br from-teal-400 to-rose-400"
                  />
                ))}
              </div>
