...
//       description: "Meticulously crafted approaches that align with your unique business objectives.",
//       color: "text-blue-500"
//     },
//     {
//       icon: Rocket,
//       title: "Innovative Solutions",
//       description: "Cutting-edge technologies that propel your business into the future.",
//       color: "text-purple-500"
//     },
//     {
//       icon: Globe,
//       title: "Global Perspective",
//       description: "Insights and strategies that transcend geographical boundaries.",
//       color: "text-violet-600"
//     },
//     {
//       icon: Zap,
//       title: "Rapid Execution",
//       description: "Swift, efficient implementation that transforms vision into reality.",
//       color: "text-cyan-400"
//     }
//   ];
...
//     <div 
//       ref={ref}
//       className="relative min-h-screen bg-black py-16 px-6 overflow-hidden"
//     >
//       {/* Subtle Geometric Background */}
//       <div className="absolute inset-0 opacity-20 pointer-events-none">
//         <div className="absolute top-0 left-0 w-1/2 h-full bg-gradient-to-br from-blue-600/20 to-purple-600/20 transform -skew-x-12"></div>
//         <div className="absolute top-0 right-0 w-1/2 h-full bg-gradient-to-bl from-indigo-600/20 to-violet-600/20 transform skew-x-12"></div>
//       </div>
...
//         >
//           <h2 className="text-6xl font-black text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-purple-500 to-violet-600 mb-6">
//             Our Mission
//           </h2>
//           <p className="text-xl text-slate-300 max-w-3xl mx-auto">
//             Transforming challenges into opportunities through strategic innovation and precise execution.
//           </p>
//         </motion.div>
...
//                 className="bg-slate-50/5 backdrop-blur-xl border border-slate-700 rounded-3xl p-8 transform transition-all duration-300 hover:scale-105 hover:shadow-2xl"
//               >
//                 <div className="flex items-center mb-6">
//                   <FeatureIcon 
//                     className={`w-12 h-12 mr-6 ${feature.color}`}
//                   />
...
//         >
//           <button 
//             className="group relative px-10 py-5 bg-gradient-to-r from-blue-500 to-purple-600 text-white font-bold rounded-full shadow-2xl hover:shadow-xl transition-all duration-300"
//             style={{ 
...
//             <span className="absolute inset-0 border-2 border-white/20 rounded-full opacity-0 group-hover:opacity-100 transition-all duration-300"></span>
//           </button>
//         </motion.div>
//       </div>
//     </div>
